...
| **🗑** | `(RETIRED — do not migrate)` | n/a | n/a | `ma_crossover` | Lagging-indicator-based (EMA20×EMA50). ICT explicitly rejects moving averages and lagging oscillators as primary triggers. No ICT primitive expressed → does not fold; removed in v2.7.137a. |
...
| `momentum_dump` | MSS_CONTINUATION_{BUY,SELL} | BOTH | FORGE.mq5:13389 (SELL), 13522 (BUY) |
| `momentum_dump_composite` | MSS_CONTINUATION_{BUY,SELL} | BOTH | FORGE.mq5:13550 |
