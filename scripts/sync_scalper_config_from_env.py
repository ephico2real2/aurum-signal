...
MAPPING: dict[str, tuple[str, str, str, float | None, float | None]] = {
    ...
    "FORGE_ICT_OB_DISPLACEMENT_MIN_ATR":                         ("safety",    "ict_ob_displacement_min_atr",                   "float",  0.5,   5.0),
    "FORGE_ICT_OB_LOOKBACK_BARS":                                ("safety",    "ict_ob_lookback_bars",                          "int",    5,     200),
    "FORGE_ICT_OB_RETEST_TOLERANCE_ATR":                         ("safety",    "ict_ob_retest_tolerance_atr",                   "float",  0.1,   3.0),
    "FORGE_ICT_OB_FVG_CONFLUENCE_TOLERANCE_ATR":                 ("safety",    "ict_ob_fvg_confluence_tolerance_atr",           "float",  0.1,   3.0),
