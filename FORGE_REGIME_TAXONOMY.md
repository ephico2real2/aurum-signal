...
### §11.7b Authority model — EA is the source of truth (v2.7.49)

**Rule**: MT5 is where orders fire. The EA's broker-clock-anchored killzone is the only clock that has a causal relationship to a trade. Every Python consumer derives from the EA's view, not the other way around.

**Implementation** (shipped v2.7.49):
